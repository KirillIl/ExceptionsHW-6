public class Data {
    ...
    private static final String VALID_CHARACTERS = "abcdefghijklmnoprstuvwxyzABCDEFGHIJKLMNOPRSTUVWXYZ0123456789_";
    ...
    private static void check (String login,
        ...
        if (!password.equals(confirmPassword)){
            throw new WrongPasswordException("Пароль должны cовпадать!");
        }
